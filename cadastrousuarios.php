   ...
   <header class="header">
    ...
    <div id="sidebar" class="sidebar py-3">
                    ...
                    <ul class="sidebar-menu list-unstyled">
                        ...
                        <li class="sidebar-list-item"><a href="cadastrousuarios.php" class="sidebar-link text-muted active"><i class="o-table-content-1 mr-3 text-gray"></i><span>Cadastrar Usuario</span></a></li>
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
          ...
          $sql = "INSERT INTO usuario(usuario, senha, niveldeacesso, horas, matricula, curso) VALUES ('$nome','$senha','$acesso','$horas','$matricula', '$curso')";
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Cadastro de usuarios no sistema</h3>
                  </div>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Matricula</label>
                        <div class="col-md-9">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Curso</label>
                        <div class="col-md-9">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-md-3 form-control-label">Nível de Acesso</label>
