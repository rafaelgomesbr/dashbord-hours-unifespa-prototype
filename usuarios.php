...
<div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
            ...
            <ul class="sidebar-menu list-unstyled">
                ...
                <li class="sidebar-list-item"><a href="usuarios.php" class="sidebar-link text-muted active"><i class="o-table-content-1 mr-3 text-gray"></i><span>Visão Geral</span></a></li>
...
<form method="get" class="card">
            <div class="card-header">
              <h6 class="text-uppercase mb-0">Usuarios cadastrados no sistema</h6>
            </div>
              ...
              <table class="table table-striped table-hover card-text">
                ...
                <?php 
                        while($exibirRegistros = mysqli_fetch_array($consulta)){
                          ...
                          $usuario_id = $exibirRegistros[0];
                          $usuario = $exibirRegistros[1];
                          $horas = $exibirRegistros[3];
                          $matricula = $exibirRegistros[4];
                          $curso = $exibirRegistros[5];
                          $niveldeacesso = $exibirRegistros[6];
                       
                          print "<article>";
                          print "<tr>";
                          
                          print "<th scope='row'>"; print "$usuario_id"; print"</th>";
                          print "<th scope='row'>"; print "$usuario"; print"</th>";
                          print "<th scope='row'>"; print "$horas"; print"</th>";
                          print "<th scope='row'>"; print "$matricula"; print"</th>";
                          print "<th scope='row'>"; print "$curso"; print"</th>";
                          print "<th scope='row'>"; print "$niveldeacesso"; print"</th>";
